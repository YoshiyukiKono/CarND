...
I tried to use dropout layers for each activation layers. It however didn't work to improve the accuracy.
Then, I removed them without the ones before fully connected layers.
